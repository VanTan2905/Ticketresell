...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Core.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("Backend.Core.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Backend.Core.Entities.Revenue", b =>
                {
            ...
            modelBuilder.Entity("Backend.Core.Entities.SellConfig", b =>
                {
            ...
            modelBuilder.Entity("Backend.Core.Entities.Order", b =>
                {
                    b.HasOne("Backend.Core.Entities.User", "Buyer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Backend.Core.Entities.OrderDetail", b =>
                {
                    b.HasOne("Backend.Core.Entities.Order", "Order")
            ...
            modelBuilder.Entity("Backend.Core.Entities.Revenue", b =>
                {
                    b.HasOne("Backend.Core.Entities.User", "Seller")
                        .WithMany("Revenues")
            ...
            modelBuilder.Entity("Backend.Core.Entities.User", b =>
                {
                    b.HasOne("Backend.Core.Entities.SellConfig", "SellConfig")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("TicketCategory", b =>
                {
                    b.HasOne("Backend.Core.Entities.Category", null)
                        .WithMany()
